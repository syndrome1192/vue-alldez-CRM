...
export default {
    data: () => ({
        links: [
            {"title": 'Все записи', "url": '/admin/history', "icon": 'fa fa-address-book-o mr-3'},
            {"title": 'Добавить оператора', "url": '/admin/add_operators', "icon": 'fa fa-volume-control-phone mr-3'},
            {"title": 'Добавить дезинфектора', "url": '/admin/add_dezinfectors', "icon": 'fa fa-hand-spock-o mr-3'},
            {"title": 'Статистика', "url": '/admin/statistics', "icon": 'fa fa-line-chart mr-3'}
        ],
        isActive: false
    }),
    methods: {
